...
export type Find_Team_By_Id = { __typename?: 'Query' } & {
...
export type CreateTeamMutation = { __typename?: 'Mutation' } & {
  createTeam: { __typename?: 'Team' } & Pick<Team, 'id'>
}

export type PetQueryVariables = Exact<{ [key: string]: never }>

export type PetQuery = { __typename?: 'Query' } & {
...
export type DeleteTeamMutation = { __typename?: 'Mutation' } & {
  deleteTeam: { __typename?: 'Team' } & Pick<Team, 'id'>
}

export type TeamsVariables = Exact<{ [key: string]: never }>

export type Teams = { __typename?: 'Query' } & {
